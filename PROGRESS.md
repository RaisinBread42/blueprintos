...
| 4 | Save/restore scenarios locally | ~45 min | ✅ complete (`ebbfe90`) |
...
- Iteration 4: Added local scenario save/load/reset (per service line) using browser storage; auto-loads per service line on switch.
